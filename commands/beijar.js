...
if(message.channel.id !== '659603136574521364'){
  ...
  let beijarerro = new Discord.RichEmbed()
                
    .setDescription(`:warning: ${message.author} não foi possível mandar esse tipo de comando aqui !`)
    .setColor('#ff0000')

  message.channel.send(beijarerro).then(r => r.delete(12000))
    ...
    if(!member) {
      ...
      switch (random) {
        ...
        break;
        case 32: gif = 'https://66.media.tumblr.com/8525ed6243db788e052a636595edd3b9/tumblr_n019sd22Gm1trnchuo1_500.gif'
        break;
